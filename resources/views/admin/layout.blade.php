    ...
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <span class="">Easy Purchase.Com</span>
                        </a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="@yield('administrators_select')">
                            <a href="{{ asset('admin/administrators') }}">
                                <i class="zmdi zmdi-account-circle"></i>Administrators</a>
                        </li>
                        ...
                        <li class="@yield('subcategory_select')">
                            <a href="{{ url('admin/subcategory') }}">
                                <i class="far fa-list-alt"></i>Sub Category</a>
                        </li>
                        <li class="@yield('subcategory_select')">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                ...
                <span class="logo">EasyPurchase.Com</span>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('Inquery')">
                            <a href="{{ url('admin/inquiry') }}">
                                <i class="fab fa-product-hunt"></i>Product Inquiry</a>
                        </li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Welcome {{ session()->get('password'); }}</a>
                                        </div>
            ...
            jQuery('select[name="category"]').on('change',function(){
               ...
               if(categoryID)
               {
                  jQuery.ajax({
                     ...
                     {
                        console.log(data);
                        jQuery('select[name="category_name"]').empty();
                        jQuery.each(data, function(key,value){
                           $('select[name="category_name"]').append('<option value="'+ key +'">'+ value +'</option>');
                        });
                     }
                  });
               }
