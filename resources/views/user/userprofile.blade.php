						...
						<!-- <div class="widget personal-info">
							...
							<form action="#"> -->
								...
								<!-- <div class="form-group">
									...
									<input type="text" value="" class="form-control" id="first-name">
								</div> -->
								<!-- Email -->
								<!-- <div class="form-group">
									<label for="last-name">Email</label>
									<input type="text" class="form-control" value="" id="last-name">
								</div> -->
								<!-- File chooser -->
        ...
        @endforeach
						<form action="{{url('change_password')}}" method="POST">
							...
							{{-- <div class="form-group">
								...
								<input type="password" name="password_cu"  class="form-control" id="current-password">
							</div> --}}
							<!-- New Password -->
							<div class="form-group">
