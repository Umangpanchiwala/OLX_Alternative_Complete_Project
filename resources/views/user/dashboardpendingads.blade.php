			...
			<div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-profile">
						...
						<a href="{{asset('user/userprofile')}}" class="btn btn-main-sm">Edit Profile</a>
					</div>
					<!-- Dashboard Links -->
					<div class="widget user-dashboard-menu">
						<ul>
							<li><a href="{{asset('user/dashboardmyads')}}"><i class="fa fa-user"></i> My Ads</a></li>
							<li class="active">
								<a href="dashboard-pending-ads.html"><i class="fa fa-bolt"></i> Pending Approval<span>23</span></a>
							</li>
							<li>
								<a href="{{asset('user/login')}}"><i class="fa fa-cog"></i> Logout</a>
							</li>
							<li>
