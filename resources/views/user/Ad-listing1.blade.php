      ...
      <fieldset class="border border-gary p-4 mb-5">
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <select name="category" id="city" class="w-100">
            ...
            {{-- <h6 class="sub_category">Select SubCategory:</h6> --}}
            {{-- <div class="form-group">

            <select class="form-control subcategory" name="category_id" id="cate" >
              <option value="">Select SubCategory</option>
            </select>

            </div> --}}

              <select name="" class="subcategory form-control" id="cate">
                  <option value="" disabled selected>subcategory</option>
              </select>

          </div>
          <div class="price">
            <h6 class="font-weight-bold ">Item Price ($ USD):</h6>
            <div class="row px-3">
